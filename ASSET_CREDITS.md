...
All game sound is synthesized at runtime with the browser Web Audio API in `assets/game.js`.

No external audio files are used.

## Code

The game code is original for this project.
